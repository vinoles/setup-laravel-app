 ...
 *
 * @OA\Get(
 *     path="/api/v1/comments/{comment}/user",
 *     operationId="retrieveCommentUser",
 *     tags={"Comments"},
 *     summary="Show comment user information",
 *     description="Show comment user endpoint",
 *     security={ {"sanctum": {} }},
 *     @OA\Parameter(
 *         name="comment",
 *         in="path",
 ...
 *
 */
class RetrieveCommentUser extends ApiDoc
{
}
